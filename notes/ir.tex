...
% - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -
\subsubsection{\texttt{IntegerConst}}

\footnotesize
\begin{alltt}
  \{
    "constraint"    : "IntegerConst",
    "value"         : \emph{integer}
  \}
\end{alltt}
\normalsize

The \texttt{IntegerConst} constraint implements the \texttt{Value}, \texttt{Equality},
\texttt{Ordinal}, and \texttt{ArithmeticOps} traits.

% - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -
\subsubsection{\texttt{BooleanConst}}

\footnotesize
\begin{alltt}
  \{
    "constraint"    : "BooleanConst",
    "value"         : \emph{True} | \emph{False}
  \}
\end{alltt}
\normalsize

The \texttt{BooleanConst} constraint implements the \texttt{Value}, \texttt{Equality},
and \emph{BooleanOps} traits.
...
\begin{alltt}
  \{
    "constraint"   : "Field",
    "name"         : \emph{field name},
    "property"     : \emph{is\_present} | \emph{value} | \emph{width}
  \}
\end{alltt}
\normalsize

The \texttt{Field} constraint implements the \texttt{Value} and \texttt{Equality} traits.

Additionally, if \texttt{property} is set to \texttt{is\_present}, the constraint implements
the \texttt{BooleanOps} trait. If \texttt{property} is set to \emph{value} or \emph{width},
the constraint implements the \emph{Ordinal} and \emph{ArithmeticOps} traits.

% - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -
\subsubsection{\texttt{Arithmetic}}
...
\begin{alltt}
  \{
    ...
    "left"         : \emph{any type that implements the} ArithmeticOps \emph{trait},
    "right"        : \emph{any type that implements the} ArithmeticOps \emph{trait},
  \}
\end{alltt}
\normalsize

% - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -
\subsubsection{\texttt{Ordinal}}
...
\begin{alltt}
  \{
    ...
    "left"         : \emph{any type that implements the} Ordinal \emph{trait},
    "right"        : \emph{any type that implements the} Ordinal \emph{trait},
  \}
\end{alltt}
\normalsize
...
\begin{alltt}
  \{
    ...
    "left"         : \emph{any type that implements the} BooleanOps \emph{trait},
    "right"        : \emph{any type that implements the} BooleanOps \emph{trait},
  \}
\end{alltt}
\normalsize
