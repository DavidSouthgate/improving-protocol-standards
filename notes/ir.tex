...
Instances of bit string types also implement the \code{Value} and
...
Arrays also implement the \code{Sized} trait. The size of the array is \code{length}
multiplied by the size of \code{element\_type}.

Arrays also implement the \code{IndexCollection} trait. Elements are numbered from $0$ to
