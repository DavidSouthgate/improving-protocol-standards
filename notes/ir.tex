...
tree (\code{Equality}, \code{Ordinal}, \code{Boolean}, \code{Arithmetic}, and \code{Conditional})
and 
...
A \code{Conditional} tree constraint is represented in the JSON form of the
intermediate representation as:
\footnotesize
\begin{alltt}
  \{
