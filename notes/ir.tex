...
The runtime implements the \code{NumberedCollection} trait. This defines methods that can
...
Arrays implement the \code{NumberedCollection} trait. Elements are numbered from $0$ to
$\code{length}-1$.
