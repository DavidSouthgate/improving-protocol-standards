...
The \texttt{Protocol} object MUST contain a \texttt{types} member that
contains a list of types used by the protocol, each being a JSON object
as listed in Section \ref{sec:types}, and a \texttt{funcs} member that
contains a list of functions used by the protocol, described in Section
\ref{sec:funcs}. These arrays MAY be empty.
