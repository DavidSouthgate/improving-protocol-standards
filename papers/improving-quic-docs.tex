...
designed for parsing individual, unencrypted packets. Our framework supports QUIC, and
other protocols, by including \emph{contexts} and \emph{functions}, to support the
flow-based parsing of encrypted packets.
