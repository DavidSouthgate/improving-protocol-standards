...
% FIXME: add Orcid for Stephen (see https://orcid.org/)
\orcid{}
\affiliation{%
...
non-conforming implementations. In this paper, we develop the Glasgow Packet Representation,
...
%==================================================================================================
\section{The Glasgow Packet Representation}
\label{sec:gpl}

In this section, we describe the Glasgow Packet Representation, an abstract protocol
...
PDUs should be parsed. The Glasgow Packet Representation is comprised of both a runtime -- a set
...
provided by \emph{runtime} of the Glasgow Packet Representation: that is, the interpreter for
...
This means that the Glasgow Packet Representation differs from previous work in this area:
...
change how they write specifications. The Glasgow Packet Representation's intermediate
...
In this section, we will demonstrate that the novel features of the Glasgow Packet Representation
...
intermediate representation that the Glasgow Packet Representation produces is agnostic to
...
In this paper, we have described the Glasgow Packet Representation, a runtime and
...
Future work begins with formally specifying the Glasgow Packet Representation, and providing
