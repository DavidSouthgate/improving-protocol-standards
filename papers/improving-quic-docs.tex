...
The \texttt{LongHeaderType} and examples of complex data types; they are themselves
structures, arrays, or derived types. 

Notably, this example contains a field transformation, described using the following
syntax:
\footnotesize
\begin{alltt}
    before_name : before_type -> after_name : after_type
\end{alltt}
\normalsize
